...
public class TravelDto {
    ...
    public TravelDto(double origin_lat, double origin_lon, double destination_lat, double destination_lon, TravelPaying travelPay) {
    ...
    public TravelDto(double origin_lat, double origin_lon, double destination_lat, double destination_lon, double price, String passenger_userName, String driver_userName, TravelPaying travelPaying) {
        this.origin_lat = origin_lat;
        this.origin_lon = origin_lon;
        this.destination_lat = destination_lat;
        this.destination_lon = destination_lon;
